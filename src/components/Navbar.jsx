...
const Navbar = () => {
  ...
  return (
    <div className='fixed w-full h-[70px] flex justify-between items-center px-4 pt-2 bg-[#0b1016] text-[#b48d22]'  style={{zIndex:6}}>
      <div>
        <h1 className=' font-thin text-2xl font-sans-serif'>JK</h1>
      </div>
      {/* menu */}
        ...
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-130px] hover:ml-[-40px] duration-300 bg-blue-600'>
            <a
              ...
              href='https://www.linkedin.com/in/jetson-ku-141b7b1a1/'
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-130px] hover:ml-[-40px] duration-300 bg-[#333333]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='https://github.com/jetsonku'
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-130px] hover:ml-[-40px] duration-300 bg-blue-600'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='https://www.twitter.com/JetsonKu'
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-130px] hover:ml-[-40px] duration-300 bg-[#6fc2b0]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href="mailto:jetsonku@gmail.com"
            >
